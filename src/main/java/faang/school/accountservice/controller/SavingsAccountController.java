...
public class SavingsAccountController {
    ...
    @PostMapping()
    public SavingsAccountDto openSavingAccount(
            @RequestBody @Validated(SavingsAccountDto.Create.class) SavingsAccountDto savingsAccountDto) {
        return savingsAccountService.openSavingsAccount(savingsAccountDto);
    }

    @ResponseStatus(HttpStatus.OK)
    @GetMapping("/{id}")
    public SavingsAccountDto getSavingAccount(
    ...
    @ResponseStatus(HttpStatus.OK)
    @GetMapping()
    public List<SavingsAccountDto> getSavingAccountByUserId(
            @NotNull @Positive(message = "id must be positive")
