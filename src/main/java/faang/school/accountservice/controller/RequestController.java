...
public class RequestController {
    ...
    public RequestDto updateStatus(@PathVariable Long requestId, RequestStatusDto requestStatusDto) {
        return requestService.updateRequestStatus(requestId, requestStatusDto);
    }

    @PutMapping("/flag/{requestId}")
    public RequestDto updateFlag(@PathVariable Long requestId, boolean flag) {
