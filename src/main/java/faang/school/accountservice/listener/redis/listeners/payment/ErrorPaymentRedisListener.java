...
@Component
public class ErrorPaymentRedisListener extends AbstractEventListener<ErrorPaymentRequest> {
    private final BalanceService balanceService;

    @Value("${spring.data.redis.channel.error-payment.request}")
    String topicName;

    public ErrorPaymentRedisListener(ObjectMapper objectMapper,
    ...
    @Override
    public void saveEvent(ErrorPaymentRequest event) {
        balanceService.errorPayment(event);
    }
