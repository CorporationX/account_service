...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleDataValidationException(ResourceNotFoundException ex) {
        return new ResponseEntity<>(response(ex), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(UnsupportedOperationException.class)
    public ResponseEntity<Object> handleDataValidationException(UnsupportedOperationException ex) {
