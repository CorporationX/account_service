...
public class CancelingDmsEventHandler implements DmsEventHandler {
    private final ReserveService reserveService;

    @Override
    public void handle(DmsEventDto dmsEventDto) {
        reserveService.cancelReserve(dmsEventDto.getRequestId());
    }

    @Override
    public DmsTypeOperation getTypeOperation() {
        return DmsTypeOperation.CANCELING;
    }
}
