...
(
    ...
    request_type              VARCHAR(32) NOT NULL CHECK (request_type IN ('IN PROGRESS', 'BLOCKED', 'DECLINE', 'DONE')),
    lock_key                  VARCHAR(64) NOT NULL,
    is_open                   BOOLEAN NOT NULL DEFAULT TRUE,
    input_request             JSONB NOT NULL,
    request_status            VARCHAR(32) NOT NULL CHECK (request_status IN ('TO DO', 'WAITING', 'DECLINE', 'DONE')),
