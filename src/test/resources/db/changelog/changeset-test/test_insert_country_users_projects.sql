...
INSERT INTO project (id, name, description, storage_size, max_storage_size, owner_id, status, visibility)
VALUES
    (1, 'First test project', 'Some description', 105158, 2000000, 1, 'CREATED', 'PUBLIC'),
    (2, 'Second test project', 'Some description', 105158, 2000000, 1, 'CREATED', 'PUBLIC');